...
const Map = () => {
  return (
    <div className="w-full h-full">
      <div className="mb-8 flex flex-col space-y-4 "> {/* Adjusted margin-top */}
        <h1 className="text-3xl text-black font-bold dark:text-white items-center text-center">Our Location</h1>
